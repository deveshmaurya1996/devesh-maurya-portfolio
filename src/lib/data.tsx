...
export const EXPERIENCES: ExperienceDetails[] = [
  ...
  // },
  {
    ...
    currentlyWorkHere: false,
    summary: [
      "Developed innovative 2D game generation tools utilizing Vite.js, Next.js, Redux, and TanStack Query.",
      "Integrated AI-driven APIs to enhance game asset recommendations and procedural content generation.",
      "Designed and implemented interactive UI components for game level design, improving user engagement.",
      "Optimized application performance, resulting in a seamless and responsive gaming experience.",
    ],
  },
  {
    logo: labLambworks,
    ...
    currentlyWorkHere: false,
    summary: [
      "Working on a project called Airhub.",
      "Website Building, Cascading Style Sheets (CSS), React Native, React, Next.js, Gatsby, TypeScript, PostgreSQL, MUI, MongoDB and related technologies.",
    ],
  },
];
